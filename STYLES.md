...
- Host filtering is an app switcher, not a dropdown. Each host is represented by a selectable logo tile; placeholder initials are acceptable until host logo assets exist.
